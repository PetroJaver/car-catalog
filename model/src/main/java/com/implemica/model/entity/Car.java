...
@Table(name = "car", uniqueConstraints = {
        @UniqueConstraint(name = "UniqueCarConstraint", columnNames = {"car_brand","car_model","car_body_type","car_year",
        "car_transmission_type", "car_engine_size"})
})
...
public class Car {
    ...
    @ApiModelProperty(value = "Image name for car. Download a image, " +
            "you need to follow the link <link Amazon Web Service S3 bucket\\ + imageName>.", example = "defaultImageCar.png")
