...
public class EditCarPage extends BaseSeleniumPage {
    ...
    public EditCarPage openEditFirstCarPage() {
    ...
    public EditCarPage clickTransmissionManual() {
    ...
    public EditCarPage clickTransmissionAutomatic() {
    ...
    public EditCarPage clickDeleteOption(String option) {
    ...
    public EditCarPage inputOption(String option) {
    ...
    public EditCarPage deleteAllOptions(){
    ...
    public EditCarPage fillForm(CarValue carValue) {
